...
CREATE TABLE IF NOT EXISTS tb_transferencia_bancaria (
    ...
    num_agencia_conta_origem VARCHAR(10) NOT NULL,
    num_conta_origem VARCHAR(10) NOT NULL,
    num_agencia_conta_destino VARCHAR(10) NOT NULL,
    num_conta_destino VARCHAR(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS tb_saldo_conta_corrente (
    ...
    num_agencia_conta_corrente VARCHAR(10) NOT NULL,
